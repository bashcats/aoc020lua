...
day17.make_iter_neighbours = function()
	...
	for x = -1, 1 do
		for y = -1, 1 do
			for z = -1, 1 do
				for w = -1, 1 do
					if z == 0 and y == 0 and x == 0 and w == 0 then
					else
						vec[#vec + 1] = { x, y, z, w }
					end
				end
	...
	return function(coord)
		...
		return function()
			...
			return { coord[1] + v[1], coord[2] + v[2], coord[3] + v[3], coord[4] + v[4] }
		end
	end
end
